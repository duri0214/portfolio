...
/**
 * レーダーチャート based on d3
 * @param {*} parent_selector
 * @param {*} data
 * @param {{margin: {top: number, left: number, bottom: number, right: number}, unit: string, color, legend: {translateY: number, translateX: number, title: string}, w: number, h: number, format: string, roundStrokes: boolean, levels: number, dotRadius: number}} options
 * @see https://gist.github.com/mthh/7e17b680b35b83b49f1c22a3613bd89f
 */
const RadarChart = function (parent_selector, data, options) {
