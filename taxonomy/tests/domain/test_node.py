...
class TestNode(TestCase):
    def setUp(self) -> None:
        self.data = [
            {
                'kingdom_name': '動物界', 'phylum_name': '環形動物門', 'classification_name': '貧毛綱',
                'family_name': 'ツリミミズ科',
                'genus_name': 'シマミミズ属', 'species_name': 'シマミミズ種', 'breed_name': 'シマミミズ',
                'breed_name_kana': 'シマミミズ',
                'natural_monument_name': None, 'breed_tag': 'コンポスト'
            },
            {
                'kingdom_name': '動物界', 'phylum_name': '脊椎動物門', 'classification_name': '鳥綱',
                'family_name': 'キジ科',
