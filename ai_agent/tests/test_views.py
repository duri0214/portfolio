...
class AgentStreamingViewTest(TestCase):
    ...
    def test_streaming_endpoint_persists_completed_tool_history(self):
        ...
        self.assertContains(page, "履歴をリプレイ")
        self.assertContains(page, "AgentRun / Tool Call / Tool Result / Report")
        self.assertContains(page, "stream-run-1")
        self.assertContains(page, "Tool Call")
        self.assertContains(page, "Tool Result")
