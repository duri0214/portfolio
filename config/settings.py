"""
Django settings for a portfolio project.
...
GOOGLE_MAPS_FE_API_KEY = os.getenv(
    "GOOGLE_MAPS_FE_API_KEY", os.getenv("GOOGLE_MAPS_JAVASCRIPT_API_KEY", "")
)
GOOGLE_MAPS_MAP_ID = os.getenv("GOOGLE_MAPS_MAP_ID", "8f6a4cf0806f4732")
