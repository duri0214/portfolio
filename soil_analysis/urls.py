...
urlpatterns = [
    ...
    path(
        ...
        name="soilhardness_upload",
    ),
    path(
        "soilhardness/success",
        views.SoilhardnessSuccessView.as_view(),
        name="soilhardness_success",
    ),
    path(
        "soilhardness/association",
        views.SoilhardnessAssociationView.as_view(),
        name="soilhardness_association",
    ),
    path(
        "soilhardness/association/individual/<int:memory_anchor>/<int:land_ledger>",
        views.SoilhardnessAssociationIndividualView.as_view(),
        name="soilhardness_association_individual",
    ),
    path(
        "soilhardness/association/success",
