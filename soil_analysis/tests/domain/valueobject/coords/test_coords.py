...
class TestCoords(TestCase):
    ...
    def test_capture_location_coord_get_coords(self):
        ...
        self.assertEqual((34.7443565, 137.6489657), capture_location_coords.get_coords())
        self.assertEqual("34.7443565, 137.6489657", capture_location_coords.get_coords(to_str=True))
