...
class TestView(TestCase):
    ...
    def test_get_store_planning_page_200(self):
        ...
        StorePlanningDataSourceSnapshot.objects.create(
            source_key="estat_population_age_groups_13121_076002",
        ...
        self.assertContains(response, "東京都足立区保木間二丁目")
        ...
        self.assertContains(response, "city=13121, town=076002")
        ...
        self.assertContains(response, "比較対象地域（保木間一丁目）")
        self.assertContains(response, "city=13121, town=076001")
    ...
    def test_store_planning_page_ignores_comparison_area_as_store_selection(self):
        ...
        - 処理: 出店計画画面をGETする。
        - 期待値: 店舗候補はChapter Tableのまま、比較対象地域として保木間一丁目が表示されること。
        """
        StorePlanningDataSourceSnapshot.objects.create(
        ...
        url = f"{reverse('shp:store_planning')}?store=area-hokima-1"
    ...
    def test_store_planning_page_displays_estat_code_based_comparison_candidates(
        ...
        StorePlanningDataSourceSnapshot.objects.create(
            source_key="estat_population_age_groups_13121_076002",
            display_name="e-Stat 国勢調査 年齢別人口: 東京都足立区保木間二丁目",
            source_url="https://www.e-stat.go.jp/stat-search/files",
            status="取得済み: 東京都足立区保木間二丁目 の年齢別人口",
            data_period="令和2年国勢調査 小地域集計",
            source_updated_at=timezone.now(),
            raw_data={
                "stat_inf_id": "000032163275",
        ...
        StorePlanningDataSourceSnapshot.objects.create(
            source_key="estat_population_age_groups_13121_076003",
            display_name="e-Stat 国勢調査 年齢別人口: 東京都足立区保木間三丁目",
            source_url="https://www.e-stat.go.jp/stat-search/files",
            status="取得済み: 東京都足立区保木間三丁目 の年齢別人口",
            data_period="令和2年国勢調査 小地域集計",
            source_updated_at=timezone.now(),
            raw_data={
                "stat_inf_id": "000032163275",
        ...
        StorePlanningDataSourceSnapshot.objects.create(
            source_key="estat_population_age_groups_13121_076004",
            display_name="e-Stat 国勢調査 年齢別人口: 東京都足立区保木間四丁目",
            source_url="https://www.e-stat.go.jp/stat-search/files",
            status="取得済み: 東京都足立区保木間四丁目 の年齢別人口",
            data_period="令和2年国勢調査 小地域集計",
            source_updated_at=timezone.now(),
            raw_data={
                "target_area_name": "東京都足立区保木間四丁目",
                "large_area_name": "保木間",
                "city_code": "13121",
                "town_code": "076004",
                "area_hierarchy_level": "4",
        ...
        StorePlanningDataSourceSnapshot.objects.create(
            source_key="estat_population_age_groups_13121_076005",
            display_name="e-Stat 国勢調査 年齢別人口: 東京都足立区保木間五丁目",
            source_url="https://www.e-stat.go.jp/stat-search/files",
            status="取得済み: 東京都足立区保木間五丁目 の年齢別人口",
            data_period="令和2年国勢調査 小地域集計",
            source_updated_at=timezone.now(),
            raw_data={
                "target_area_name": "東京都足立区保木間五丁目",
                "large_area_name": "保木間",
                "city_code": "13121",
                "town_code": "076005",
                "area_hierarchy_level": "4",
        ...
        self.assertEqual(200, response.status_code)
        self.assertContains(response, "東京都足立区保木間一丁目")
        self.assertContains(response, "東京都足立区保木間三丁目")
        self.assertContains(response, "東京都足立区保木間四丁目")
        self.assertContains(response, "東京都足立区保木間五丁目")
        self.assertContains(response, "city=13121, town=076001")
        self.assertContains(response, "city=13121, town=076003")
        self.assertContains(response, "city=13121, town=076004")
        self.assertContains(response, "city=13121, town=076005")
        ...
        self.assertNotContains(response, "比較対象地域（保木間一丁目）")
