...
### 3. Django (settings.py) 設定
- [ ] **パーミッション指定**: 以下の 2 行が含まれているか？
  ```python
  FILE_UPLOAD_PERMISSIONS = 0o664
  FILE_UPLOAD_DIRECTORY_PERMISSIONS = 0o775
  ```
  - アプリ側でも明示的にグループ書き込み許可を出す必要がある。
...
## 運用
`commit-and-pr.md` のステップ 0 に基づき、PR作成前に必ずこの基準で `docs/qiita/` および `README.md` をレビューしてください。
