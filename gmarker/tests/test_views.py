...
class TestView(TestCase):
    ...
    def setUpTestData(cls):
        ...
        StoreInformation.objects.create(category=9, shop_name='渋谷駅', shop_latlng='35.6598003,139.7023894',
                                        create_at='2023-02-12 00:00:00')
        StoreInformation.objects.create(category=3, shop_name='忠犬ハチ公像', shop_latlng='35.6590439,139.7005917',
                                        create_at='2023-02-12 00:00:00')
        StoreInformation.objects.create(category=3, shop_name='明治神宮', shop_latlng='35.676236,139.6993411',
                                        create_at='2023-02-12 00:00:00')
